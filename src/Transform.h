...
public:
    ...
    Transform2f(const Eigen::Vector2f& translation, const Eigen::Rotation2D<float>& rotation)
        : translation_(translation), rotation_(rotation)
    {
    }

    Transform2f(const Eigen::Vector2f& translation, const double rotation)
        : translation_(translation), rotation_(rotation)
    {
    }
    ...
    static Transform2f Rotation(const double rotation) { return Transform2f(Eigen::Vector2f::Zero(), rotation); }
    ...
    static Transform2f Identity() { return Transform2f(); }
